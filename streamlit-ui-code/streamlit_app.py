...
st.title("ABC Finance: Credit Risk Modelling")

# Create 3 columns with rows
row1 = st.columns(3)
row2 = st.columns(3)
row3 = st.columns(3)
row4 = st.columns(3)
...
with row1[1]:
    income = st.number_input("Income",min_value=0,value=2000000)
...
with row2[0]:
    ...
    st.text(f"{loan_to_income_ratio}")
